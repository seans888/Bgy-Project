...
$page_title       = 'ListView: Region';
$db_subclass      = 'region';
$html_subclass    = 'region_html';
$arr_pkey_name    = array('region_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add region';
$edit_link        = 'Edit region';
$delete_link      = 'Delete region';
$view_link        = 'View region';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_region.php';
$edit_page        = 'edit_region.php';
$delete_page      = 'delete_region.php';
$view_page        = 'detailview_region.php';
$csv_page         = 'csv_region.php';
$report_page      = 'reporter_region.php';
