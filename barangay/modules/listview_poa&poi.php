...
$page_title       = 'ListView: Poa&poi';
$db_subclass      = 'poa&poi';
$html_subclass    = 'poa&poi_html';
$arr_pkey_name    = array('poa_poi_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add poa&poi';
$edit_link        = 'Edit poa&poi';
$delete_link      = 'Delete poa&poi';
$view_link        = 'View poa&poi';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_poa&poi.php';
$edit_page        = 'edit_poa&poi.php';
$delete_page      = 'delete_poa&poi.php';
$view_page        = 'detailview_poa&poi.php';
$csv_page         = 'csv_poa&poi.php';
$report_page      = 'reporter_poa&poi.php';
