...
$page_title       = 'ListView: Bulletin';
$db_subclass      = 'bulletin';
$html_subclass    = 'bulletin_html';
$arr_pkey_name    = array('bulletin_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add bulletin';
$edit_link        = 'Edit bulletin';
$delete_link      = 'Delete bulletin';
$view_link        = 'View bulletin';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_bulletin.php';
$edit_page        = 'edit_bulletin.php';
$delete_page      = 'delete_bulletin.php';
$view_page        = 'detailview_bulletin.php';
$csv_page         = 'csv_bulletin.php';
$report_page      = 'reporter_bulletin.php';
