...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_barangay->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_barangay->edit($arr_form_data);
...
$html->draw_header('Edit Barangay', $message, $message_type);
