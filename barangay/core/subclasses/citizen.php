...
class citizen extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $bind_params = array('isssssssissiisssssisssssssssssssssss',
                                 ...
                                 &$this->fields['proof_of_identity']['value'],
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $bind_params = array('sssssssissiisssssisssssssssssssssssi',
                                 &$this->fields['first_name']['value'],
                                 &$this->fields['middle_name']['value'],
                                 &$this->fields['last_name']['value'],
                                 &$this->fields['gender']['value'],
