...
class bulletin extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('bulletin_id, bulletin_name, bulletin_description, bulletin_date, file_document, category');
            $this->set_values("?,?,?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("bulletin_name = ?, bulletin_description = ?, bulletin_date = ?, file_document = ?, category = ?");
