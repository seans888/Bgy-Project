...
class request_has_requirement extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('request_has_requirement_id, date_submitted, requirement_document');
            $this->set_values("?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("date_submitted = ?, requirement_document = ?");
    ...
    function delete_many($param)
    {
        $this->set_parameters($param);
        $this->set_query_type('DELETE');
        $this->set_where("requirement_document = ?");
