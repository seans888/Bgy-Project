    ...
    static function load_dictionary()
    {
        $fields = array(
                        ...
                        'request_id' => array('value'=>'',
                                              ...
                                              'list_settings'=>array('query' => "SELECT request.request_id AS `Queried_request_id`, request.service_id FROM request ORDER BY request_id ASC",
                                                                     'list_value' => 'Queried_request_id',
                                                                     'list_items' => array('service_id'),
