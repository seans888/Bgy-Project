...
{
	$html->fields['barangay']['list_settings']['query'] = "SELECT barangay.barangay_id AS `Queried_barangay_id`, barangay.barangay_name FROM barangay ORDER BY barangay_name ASC";
...
{
	$html->fields['district']['list_settings']['query'] = "SELECT barangay.barangay_id AS `Queried_barangay_id`, barangay.district_number FROM barangay ORDER BY district_number ASC";
