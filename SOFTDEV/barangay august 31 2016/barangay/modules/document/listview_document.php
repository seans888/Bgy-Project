...
$page_title       = 'ListView: Document';
$db_subclass      = 'document';
$html_subclass    = 'document_html';
$arr_pkey_name    = array('document_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add document';
$edit_link        = 'Edit document';
$delete_link      = 'Delete document';
$view_link        = 'View document';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_document.php';
$edit_page        = 'edit_document.php';
$delete_page      = 'delete_document.php';
$view_page        = 'detailview_document.php';
$csv_page         = 'csv_document.php';
$report_page      = 'reporter_document.php';
