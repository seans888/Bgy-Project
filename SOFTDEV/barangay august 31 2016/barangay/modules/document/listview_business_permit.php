...
$page_title       = 'ListView: Business Permit';
$db_subclass      = 'business_permit';
$html_subclass    = 'business_permit_html';
$arr_pkey_name    = array('business_permit_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add business permit';
$edit_link        = 'Edit business permit';
$delete_link      = 'Delete business permit';
$view_link        = 'View business permit';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_business_permit.php';
$edit_page        = 'edit_business_permit.php';
$delete_page      = 'delete_business_permit.php';
$view_page        = 'detailview_business_permit.php';
$csv_page         = 'csv_business_permit.php';
$report_page      = 'reporter_business_permit.php';
