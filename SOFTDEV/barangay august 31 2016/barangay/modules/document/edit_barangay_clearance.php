...
//****************************************************************************************
require 'path.php';
init_cobalt('Edit barangay clearance');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_barangay_clearance->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_barangay_clearance->edit($arr_form_data);
...
$html->draw_header('Edit Barangay Clearance', $message, $message_type);
