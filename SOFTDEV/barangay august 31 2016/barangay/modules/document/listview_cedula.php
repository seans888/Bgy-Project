...
$page_title       = 'ListView: Cedula';
$db_subclass      = 'cedula';
$html_subclass    = 'cedula_html';
$arr_pkey_name    = array('cedula_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add cedula';
$edit_link        = 'Edit cedula';
$delete_link      = 'Delete cedula';
$view_link        = 'View cedula';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_cedula.php';
$edit_page        = 'edit_cedula.php';
$delete_page      = 'delete_cedula.php';
$view_page        = 'detailview_cedula.php';
$csv_page         = 'csv_cedula.php';
$report_page      = 'reporter_cedula.php';
