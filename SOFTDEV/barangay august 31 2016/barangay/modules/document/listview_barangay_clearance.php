...
$page_title       = 'ListView: Barangay Clearance';
$db_subclass      = 'barangay_clearance';
$html_subclass    = 'barangay_clearance_html';
$arr_pkey_name    = array('barangay_clearance_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add barangay clearance';
$edit_link        = 'Edit barangay clearance';
$delete_link      = 'Delete barangay clearance';
$view_link        = 'View barangay clearance';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_barangay_clearance.php';
$edit_page        = 'edit_barangay_clearance.php';
$delete_page      = 'delete_barangay_clearance.php';
$view_page        = 'detailview_barangay_clearance.php';
$csv_page         = 'csv_barangay_clearance.php';
$report_page      = 'reporter_barangay_clearance.php';
