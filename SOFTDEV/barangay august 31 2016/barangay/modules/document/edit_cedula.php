...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_cedula->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
...
$html->draw_header('Edit Cedula', $message, $message_type);
