...
$page_title       = 'ListView: Fee';
$db_subclass      = 'fee';
$html_subclass    = 'fee_html';
$arr_pkey_name    = array('fee_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add fee';
$edit_link        = 'Edit fee';
$delete_link      = 'Delete fee';
$view_link        = 'View fee';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_fee.php';
$edit_page        = 'edit_fee.php';
$delete_page      = 'delete_fee.php';
$view_page        = 'detailview_fee.php';
$csv_page         = 'csv_fee.php';
$report_page      = 'reporter_fee.php';
