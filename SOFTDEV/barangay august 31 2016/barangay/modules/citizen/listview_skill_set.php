...
$page_title       = 'ListView: Skill Set';
$db_subclass      = 'skill_set';
$html_subclass    = 'skill_set_html';
$arr_pkey_name    = array('skill_set_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add skill set';
$edit_link        = 'Edit skill set';
$delete_link      = 'Delete skill set';
$view_link        = 'View skill set';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_skill_set.php';
$edit_page        = 'edit_skill_set.php';
$delete_page      = 'delete_skill_set.php';
$view_page        = 'detailview_skill_set.php';
$csv_page         = 'csv_skill_set.php';
$report_page      = 'reporter_skill_set.php';
