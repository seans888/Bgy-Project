...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        $message .= $dbh_skill_set->sanitize($arr_form_data)->lst_error;
        extract($arr_form_data);

        if($dbh_skill_set->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_skill_set->edit($arr_form_data);
...
$html->draw_header('Edit Skill Set', $message, $message_type);
