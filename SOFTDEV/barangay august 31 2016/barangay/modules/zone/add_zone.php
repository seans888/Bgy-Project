...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            $dbh_zone->add($arr_form_data);
            

            redirect("listview_zone.php?$query_string");
        }
    }
	if ($arr_form_data['city_id'] != "")
	{
		$chosen_city = $arr_form_data['city_id'];
	}
}
require 'subclasses/zone_html.php';
$html = new zone_html;
$html->draw_header('Add Zone', $message, $message_type);
$html->draw_listview_referrer_info($filter_field_used, $filter_used, $page_from, $filter_sort_asc, $filter_sort_desc);
require 'components/set_city_barangay.php';
