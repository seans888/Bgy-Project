...
$page_title       = 'ListView: Zone';
$db_subclass      = 'zone';
$html_subclass    = 'zone_html';
$arr_pkey_name    = array('zone_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add zone';
$edit_link        = 'Edit zone';
$delete_link      = 'Delete zone';
$view_link        = 'View zone';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_zone.php';
$edit_page        = 'edit_zone.php';
$delete_page      = 'delete_zone.php';
$view_page        = 'detailview_zone.php';
$csv_page         = 'csv_zone.php';
$report_page      = 'reporter_zone.php';
