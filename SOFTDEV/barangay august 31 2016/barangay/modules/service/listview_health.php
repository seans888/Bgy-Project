...
$page_title       = 'ListView: Health';
$db_subclass      = 'health';
$html_subclass    = 'health_html';
$arr_pkey_name    = array('health_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add health';
$edit_link        = 'Edit health';
$delete_link      = 'Delete health';
$view_link        = 'View health';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_health.php';
$edit_page        = 'edit_health.php';
$delete_page      = 'delete_health.php';
$view_page        = 'detailview_health.php';
$csv_page         = 'csv_health.php';
$report_page      = 'reporter_health.php';
