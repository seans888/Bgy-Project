...
$page_title       = 'ListView: Health Center';
$db_subclass      = 'health_center';
$html_subclass    = 'health_center_html';
$arr_pkey_name    = array('heath_center_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add health center';
$edit_link        = 'Edit health center';
$delete_link      = 'Delete health center';
$view_link        = 'View health center';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_health_center.php';
$edit_page        = 'edit_health_center.php';
$delete_page      = 'delete_health_center.php';
$view_page        = 'detailview_health_center.php';
$csv_page         = 'csv_health_center.php';
$report_page      = 'reporter_health_center.php';
