...
$page_title       = 'ListView: School';
$db_subclass      = 'school';
$html_subclass    = 'school_html';
$arr_pkey_name    = array('school_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add school';
$edit_link        = 'Edit school';
$delete_link      = 'Delete school';
$view_link        = 'View school';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_school.php';
$edit_page        = 'edit_school.php';
$delete_page      = 'delete_school.php';
$view_page        = 'detailview_school.php';
$csv_page         = 'csv_school.php';
$report_page      = 'reporter_school.php';
