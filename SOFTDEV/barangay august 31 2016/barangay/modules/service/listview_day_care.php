...
$page_title       = 'ListView: Day Care';
$db_subclass      = 'day_care';
$html_subclass    = 'day_care_html';
$arr_pkey_name    = array('day_care_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add day care';
$edit_link        = 'Edit day care';
$delete_link      = 'Delete day care';
$view_link        = 'View day care';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_day_care.php';
$edit_page        = 'edit_day_care.php';
$delete_page      = 'delete_day_care.php';
$view_page        = 'detailview_day_care.php';
$csv_page         = 'csv_day_care.php';
$report_page      = 'reporter_day_care.php';
