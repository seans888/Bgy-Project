...
$page_title       = 'ListView: Skill';
$db_subclass      = 'skill';
$html_subclass    = 'skill_html';
$arr_pkey_name    = array('skill_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add skill';
$edit_link        = 'Edit skill';
$delete_link      = 'Delete skill';
$view_link        = 'View skill';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_skill.php';
$edit_page        = 'edit_skill.php';
$delete_page      = 'delete_skill.php';
$view_page        = 'detailview_skill.php';
$csv_page         = 'csv_skill.php';
$report_page      = 'reporter_skill.php';
