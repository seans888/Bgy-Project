...
if ($chosen_region == "")
{
	...
	$html->fields['district']['control_type'] = 'hidden';
		$html->fields['zip_code']['control_type'] = 'hidden';
}
else
{
...
else
{
	...
	$html->fields['zip_code']['list_settings']['query'] = "SELECT city.city_id AS `Queried_city_id`, city.zip_code AS zipcode FROM city WHERE city.city_id=$chosen_city ORDER BY zip_code ASC";
