...
class nationality extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('nationality_id, nationality');
            $this->set_values("?,?");

            $bind_params = array('is',
                                 &$this->fields['nationality_id']['value'],
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("nationality = ?");
            $this->set_where("nationality_id = ?");
    ...
    function check_uniqueness_for_editing($param)
    {
        ...
        $this->set_query_type('SELECT');
        $this->set_where("nationality_id = ? AND (nationality_id != ?)");
