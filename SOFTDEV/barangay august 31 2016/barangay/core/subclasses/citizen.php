...
class citizen extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $bind_params = array('isssssssissiisssssissssssssssssssssiiisiss',
                                 ...
                                 &$this->fields['father_contact_number']['value'],
                                 &$this->fields['father_occupation']['value'],
                                 &$this->fields['mother_contact_number']['value'],
                                 &$this->fields['mother_occupation']['value'],
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $bind_params = array('sssssssissiisssssissssssssssssssssiiisissi',
                                 &$this->fields['first_name']['value'],
                                 &$this->fields['middle_name']['value'],
                                 &$this->fields['last_name']['value'],
                                 &$this->fields['gender']['value'],
