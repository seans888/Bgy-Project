...
class item_type extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('item_type_id, title, description, active');
            $this->set_values("?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("title = ?, description = ?, active = ?");
            $this->set_where("item_type_id = ?");
    ...
    function check_uniqueness_for_editing($param)
    {
        ...
        $this->set_query_type('SELECT');
        $this->set_where("item_type_id = ? AND (item_type_id != ?)");
