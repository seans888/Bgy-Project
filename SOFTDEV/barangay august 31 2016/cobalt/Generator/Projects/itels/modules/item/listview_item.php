...
$page_title       = 'ListView: Item';
$db_subclass      = 'item';
$html_subclass    = 'item_html';
$arr_pkey_name    = array('item_id');
...
$add_page         = 'add_item.php';
$edit_page        = 'edit_item.php';
$delete_page      = 'delete_item.php';
$view_page        = 'detailview_item.php';
$csv_page         = 'csv_item.php';
$report_page      = 'reporter_item.php';
