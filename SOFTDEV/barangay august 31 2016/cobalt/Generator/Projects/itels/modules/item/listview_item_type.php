...
//****************************************************************************************
require 'path.php';
init_cobalt('View item type');

$page_title       = 'ListView: Item Type';
$db_subclass      = 'item_type';
$html_subclass    = 'item_type_html';
$arr_pkey_name    = array('item_type_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add item type';
$edit_link        = 'Edit item type';
$delete_link      = 'Delete item type';
$view_link        = 'View item type';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_item_type.php';
$edit_page        = 'edit_item_type.php';
$delete_page      = 'delete_item_type.php';
$view_page        = 'detailview_item_type.php';
$csv_page         = 'csv_item_type.php';
$report_page      = 'reporter_item_type.php';
