...
//****************************************************************************************
require 'path.php';
init_cobalt('View position');

$page_title       = 'ListView: Position';
$db_subclass      = 'position';
$html_subclass    = 'position_html';
$arr_pkey_name    = array('position_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add position';
$edit_link        = 'Edit position';
$delete_link      = 'Delete position';
$view_link        = 'View position';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_position.php';
$edit_page        = 'edit_position.php';
$delete_page      = 'delete_position.php';
$view_page        = 'detailview_position.php';
$csv_page         = 'csv_position.php';
$report_page      = 'reporter_position.php';
