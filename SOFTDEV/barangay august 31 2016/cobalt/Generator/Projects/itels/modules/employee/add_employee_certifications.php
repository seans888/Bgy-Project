...
//****************************************************************************************
require 'path.php';
init_cobalt('Add employee certifications');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_employee_certifications->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_employee_certifications->add($arr_form_data);
...
$html->draw_header('Add Employee Certifications', $message, $message_type);
