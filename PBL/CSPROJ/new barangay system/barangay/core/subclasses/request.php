...
class request extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('request_id, service_id, citizen_id, date_filed, date_served, status, requirement_id');
            $this->set_values("?,?,?,?,?,?,?");

            $bind_params = array('iiissss',
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("service_id = ?, citizen_id = ?, date_filed = ?, date_served = ?, status = ?, requirement_id = ?");
            $this->set_where("request_id = ?");

            $bind_params = array('iissssi',
                                 &$this->fields['service_id']['value'],
                                 &$this->fields['citizen_id']['value'],
                                 &$this->fields['date_filed']['value'],
                                 &$this->fields['date_served']['value'],
