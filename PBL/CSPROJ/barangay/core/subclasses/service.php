...
class service extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('service_id, service_name, service_description, date_offered, is_offered');
            $this->set_values("?,?,?,?,?");

            $bind_params = array('issss',
                                 &$this->fields['service_id']['value'],
                                 &$this->fields['service_name']['value'],
                                 &$this->fields['service_description']['value'],
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("service_name = ?, service_description = ?, date_offered = ?, is_offered = ?");
            $this->set_where("service_id = ?");
    ...
    function check_uniqueness_for_editing($param)
    {
        ...
        $this->set_query_type('SELECT');
        $this->set_where("service_id = ? AND (service_id != ?)");
