...
$page_title       = 'ListView: Citizen';
$db_subclass      = 'citizen';
$html_subclass    = 'citizen_html';
$arr_pkey_name    = array('citizen_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add citizen';
$edit_link        = 'Edit citizen';
$delete_link      = 'Delete citizen';
$view_link        = 'View citizen';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_citizen.php';
$edit_page        = 'edit_citizen.php';
$delete_page      = 'delete_citizen.php';
$view_page        = 'detailview_citizen.php';
$csv_page         = 'csv_citizen.php';
$report_page      = 'reporter_citizen.php';
