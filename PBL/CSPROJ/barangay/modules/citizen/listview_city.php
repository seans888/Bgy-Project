...
//****************************************************************************************
require 'path.php';
init_cobalt('View city');

$page_title       = 'ListView: City';
$db_subclass      = 'city';
$html_subclass    = 'city_html';
$arr_pkey_name    = array('city_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add city';
$edit_link        = 'Edit city';
$delete_link      = 'Delete city';
$view_link        = 'View city';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_city.php';
$edit_page        = 'edit_city.php';
$delete_page      = 'delete_city.php';
$view_page        = 'detailview_city.php';
$csv_page         = 'csv_city.php';
$report_page      = 'reporter_city.php';
