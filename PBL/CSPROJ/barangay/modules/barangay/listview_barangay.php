...
$page_title       = 'ListView: Barangay';
$db_subclass      = 'barangay';
$html_subclass    = 'barangay_html';
$arr_pkey_name    = array('barangay_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add barangay';
$edit_link        = 'Edit barangay';
$delete_link      = 'Delete barangay';
$view_link        = 'View barangay';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_barangay.php';
$edit_page        = 'edit_barangay.php';
$delete_page      = 'delete_barangay.php';
$view_page        = 'detailview_barangay.php';
$csv_page         = 'csv_barangay.php';
$report_page      = 'reporter_barangay.php';
