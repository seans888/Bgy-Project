...
//****************************************************************************************
require 'path.php';
init_cobalt('View official');

$page_title       = 'ListView: Official';
$db_subclass      = 'official';
$html_subclass    = 'official_html';
$arr_pkey_name    = array('official_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add official';
$edit_link        = 'Edit official';
$delete_link      = 'Delete official';
$view_link        = 'View official';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_official.php';
$edit_page        = 'edit_official.php';
$delete_page      = 'delete_official.php';
$view_page        = 'detailview_official.php';
$csv_page         = 'csv_official.php';
$report_page      = 'reporter_official.php';
