...
//****************************************************************************************
require 'path.php';
init_cobalt('View request');

$page_title       = 'ListView: Request';
$db_subclass      = 'request';
$html_subclass    = 'request_html';
$arr_pkey_name    = array('request_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add request';
$edit_link        = 'Edit request';
$delete_link      = 'Delete request';
$view_link        = 'View request';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_request.php';
$edit_page        = 'edit_request.php';
$delete_page      = 'delete_request.php';
$view_page        = 'detailview_request.php';
$csv_page         = 'csv_request.php';
$report_page      = 'reporter_request.php';
