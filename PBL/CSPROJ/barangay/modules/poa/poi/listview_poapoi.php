...
$add_page         = 'add_poapoi.php';
$edit_page        = 'edit_poapoi.php';
$delete_page      = 'delete_poapoi.php';
$view_page        = 'detailview_poapoi.php';
$csv_page         = 'csv_poapoi.php';
$report_page      = 'reporter_poapoi.php';
