...
$page_title       = 'ListView: Notification';
$db_subclass      = 'notification';
$html_subclass    = 'notification_html';
$arr_pkey_name    = array('notification_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add notification';
$edit_link        = 'Edit notification';
$delete_link      = 'Delete notification';
$view_link        = 'View notification';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_notification.php';
$edit_page        = 'edit_notification.php';
$delete_page      = 'delete_notification.php';
$view_page        = 'detailview_notification.php';
$csv_page         = 'csv_notification.php';
$report_page      = 'reporter_notification.php';
