...
$page_title       = 'ListView: Province';
$db_subclass      = 'province';
$html_subclass    = 'province_html';
$arr_pkey_name    = array('province_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add province';
$edit_link        = 'Edit province';
$delete_link      = 'Delete province';
$view_link        = 'View province';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_province.php';
$edit_page        = 'edit_province.php';
$delete_page      = 'delete_province.php';
$view_page        = 'detailview_province.php';
$csv_page         = 'csv_province.php';
$report_page      = 'reporter_province.php';
