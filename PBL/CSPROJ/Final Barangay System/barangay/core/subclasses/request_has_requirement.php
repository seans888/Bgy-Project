...
class request_has_requirement extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('request_has_requirement_id, date_submitted, requirement_document, request_id');
            $this->set_values("?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("date_submitted = ?, requirement_document = ?, request_id = ?");
